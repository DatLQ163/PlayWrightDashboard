...
pages folder: where storage elemnt and functions with each page.
tests folder: where storage testcases
# Getting started
Run all the tests: npx playwright test
Run a single test file: npx playwright test tests/todo-page.spec.ts
# Report
Commandline to view report: npx playwright show-report